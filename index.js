...
const instagramlu = 'https://www.instagram.com/vivinavir/'; // Nama Instagramlu cok
const whatsapplu = '+62 812-2932-4172'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung Admin'; // Kapan bot lu aktif
const grupch1 = 'Ga Ada :v'; // OFFICIAL GRUP LU 1
const grupch2 = 'Ga Ada :v'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
