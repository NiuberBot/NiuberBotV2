...
//
const BotName = 'Niuber BOT'; // Nama Bot Whatsapp
const instagramlu = 'Coming Soon'; // Nama Instagramlu cok
const whatsapplu = 'https://wa.me/6281229324172'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung Owner Bot'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/Jiht2Zo7w7FG8GWR5hPFDw'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/K5ukNCEGEuL4dGDOeMuFyr'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => Bot By Niuber`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => Bot By Niuber`)
})
